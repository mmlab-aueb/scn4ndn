...
face2 = "udp://ndn.netsec.colostate.edu"

print("Configuring NFD...")
os.system('nfdc face create ' + face)
os.system('nfdc route add /ndn/gr/edu/mmlab1/%40GUEST/nikosft%40gmail.com/file1 ' + face)
os.system('nfdc face create ' + face2)
os.system('nfdc route add /ndn/gr/edu/mmlab1/%40GUEST/nikosft%40gmail.com/file2 ' + face2)
app = NDNApp()
